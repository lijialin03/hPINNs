...
class Plot:
    def __init__(self, figname, save_dir):
    ...
    def plot_6a(self, log_loss):
        ...
        vis_loss[:, 2] = vis_loss[:, :2].sum(axis=1)
    ...
    def plot_6c7c(self, log_lambda, input_valid, output_valid, input_train):
        # print(np.shape(log_lambda))
